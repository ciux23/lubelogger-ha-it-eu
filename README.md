...
- Verify the URL is accessible from your Home Assistant server
- Include `http://` or `https://` in the URL
- Check credentials are correct
- Review Home Assistant logs for errors

**Sensors show "unknown":**
- Ensure vehicles have records in LubeLogger
- Check logs for API errors
- Verify your LubeLogger version supports the API endpoints

## Support

Report issues on [GitHub](https://github.com/larry/lubelogger-ha/issues).
